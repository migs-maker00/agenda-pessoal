import { APP_VERSION, hostAtual } from "./config.js?v=2.23.4";
import { fraseFilosoficaDoDia } from "./lib/filosofia.js?v=2.23.4";
import {
  adicionarAviso,
  alternarAvisoFeito,
  avisosDoDia,
  ...
  removerAviso,
  salvarAvisosStorage,
} from "./lib/avisos-agenda.js?v=2.23.4";
import {
  criarHabitoAgua,
  ...
  textoPlanoB,
  todosMicroFeitos,
} from "./lib/habitos.js?v=2.23.4";
import {
  carregarPerfil,
  marcarPerfilInicializado,
  perfilInicializado,
  salvarPerfil,
} from "./lib/perfil.js?v=2.23.4";
import {
  correspondePreset,
...
} from "./lib/rotina-preset.js?v=2.23.4";
import {
  ...
  PLANO_B_APRENDER,
  textoSugereAprender,
} from "./lib/aprender.js?v=2.23.4";
import {
  carregarEstudo,
  resetSessaoSeNovoDia,
  salvarEstudo,
} from "./lib/estudo-hub.js?v=2.23.4";
import { iniciarVozes } from "./lib/voz-sintese.js?v=2.23.4";
import {
  atualizarResultadoLivros,
  ligarPainelEstudo,
  renderPainelEstudo,
  renderResumoHoje,
} from "./lib/estudo-ui.js?v=2.23.4";
import {
  montarOpcoesCheguei,
  renderChegueiFeito,
  renderChegueiInicio,
  renderChegueiOpcoes,
} from "./lib/cheguei.js?v=2.23.4";
import {
  aplicarSugestaoIa,
  montarPayloadContextoIa,
  pedirOpcoesContexto,
} from "./lib/contexto-ia.js?v=2.23.4";
import { faixaDoDia } from "./lib/contexto-tempo.js?v=2.23.4";
import { registrarConclusao, resumoPadroesParaIA, alertaPreditivo } from "./lib/padroes.js?v=2.23.4";
import {
  mensagemStreakGlobal,
  mensagemStreakHabito,
  rotuloStreakInsights,
} from "./lib/streak-gentil.js?v=2.23.4";
import { modoBarulho, definirModoBarulho, filtrarModoBarulho } from "./lib/modo-barulho.js?v=2.23.4";
import { detectarTransicao, mensagemTransicao } from "./lib/transicao-coach.js?v=2.23.4";
import { aplicarPreparoNoite, textoPreparoManha } from "./lib/preparar-amanha.js?v=2.23.4";
import { interpretarFala, rotuloContextoVoz } from "./lib/voz-contexto.js?v=2.23.4";
import { pedirResumoDiario, pedirPlanoSemana } from "./lib/ia-servicos.js?v=2.23.4";
import {
...
} from "./lib/estudo-parceiro.js?v=2.23.4";
import { escutarDictado, pararEscuta, suportaReconhecimentoVoz } from "./lib/estudo-fala.js?v=2.23.4";
import {
  arquivarVersaoNota,
  ...
  rotuloMotivoVersao,
} from "./lib/diario-historico.js?v=2.23.4";
import {
  aplicarExplicacoesNeuro,
  carregarExplicacoesNeuro,
  mesclarExplicacoesNeuro,
} from "./lib/neuro-explicar.js?v=2.23.4";
import { sondarIaNeuro, iaNeuroDisponivel } from "./lib/neuro-ia.js?v=2.23.4";
import {
  marcarGuiaVisto,
  marcarPassoGuia,
  guiaJaVisto,
  ...
  ROTEIRO_DEMO,
} from "./lib/guia-app.js?v=2.23.4";
import { aplicarIdiomaHtml, definirCallbackIdioma, localeTag, setLocale, t } from "./lib/i18n.js?v=2.23.4";
import {
...
} from "./lib/migracao-host.js?v=2.23.4";
import {
  ehHorarioDificil,
  mensagemTarde,
  sugestaoTarde,
} from "./lib/tarde.js?v=2.23.4";
import {
  complementoCoachDiario,
  gerarResumoSemana,
  sugerirHabito,
  textoSugestao,
} from "./lib/inteligencia.js?v=2.23.4";
import {
  ...
  verificarLembretes,
} from "./lib/lembretes.js?v=2.23.4";
import { sincronizarAgendaSW } from "./lib/agenda-notif.js?v=2.23.4";
import {
  cancelarTimer,
  cronometroAtivo,
  formatarTimer,
  ...
  textoCountdown,
  timerAtivo,
} from "./lib/foco.js?v=2.23.4";
import {
  carregarPerfilRotina,
  gerarRotina,
  salvarPerfilRotina,
} from "./lib/rotina-local.js?v=2.23.4";
import {
  adicionarInbox,
  alternarPrioridade,
  aplicarLimiteDiario,
